...
public:
    ...
    void GetVec(NestedInteger& integer) {
      if (integer.isInteger()) {
        result_.push_back(integer.getInteger());
        //cout << "integer.getInteger: " << integer.getInteger() <<endl;
        //for (auto& val : result_) {
        //  cout << "getvec: " << val << endl;
        //}
        return;
      }
      for (auto& val : integer.getList()) {
        GetVec(val);
      }
    }
